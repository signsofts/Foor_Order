                ...
                <table class="table table-borderless text-center table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="edit.php?edit=<?php echo $data['menu_id']; ?>"><img src="../SVG/edit_logo.svg" alt="แก้ไขเมนูอาหาร" class="bt_logo"></a></td>
                            <td><a href="delete_script.php?delete=<?php echo $data['menu_id'];?>"><img src="../SVG/delete_logo.svg" alt="ลบเมนูอาหาร" class="bt_logo"></a></td>
                        </tr> 
                        <?php
                                    $no++;
                                }
