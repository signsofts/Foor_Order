                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if($data['payment_status']==0){
                                echo "<h4 style='color:red'>ยังไม่ได้ชำระเงิน</h4>";
                            } ?></td>
                            <td><a href="order_detail.php?edit=<?php echo $data['order_id']; ?>"><img src="../SVG/receipt.svg" alt="แสดงยอดชำระเงิน" class="bt_logo"></a></td>
                        </tr> 
                        <?php
                                    $no++;
                                }
